...
const STORE_VARIANTS = [
  'Курьерская доставка по Москве и Я.Доставка по всей России.',
  'Отправляем курьером по Москве или Я.Доставкой в любой город России.',
  'Доставка курьером по Москве; по России — через сеть Я.Доставки.',
  'Курьер по Москве в день заказа или Я.Доставка в любой регион России.',
];

const FREE_DELIVERY_VARIANTS = [
  'Оплата картой онлайн или наличными при получении.',
  'Принимаем онлайн-оплату и наложенный платёж при доставке.',
  'Гибкая оплата: онлайн на сайте или при получении заказа.',
];

const GUARANTEE_VARIANTS = [
  'Гарантия производителя 1 год.',
  'Гарантия 12 месяцев, собственный сервисный центр.',
