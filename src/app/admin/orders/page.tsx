    ...
    <div className="min-h-screen bg-bg">
      ...
      <nav className="bg-surface border-b border-border">
        <div className="max-w-7xl mx-auto px-4 flex gap-1">
          <Link href="/admin" className="px-4 py-3 text-sm font-medium text-text-muted hover:text-text">Дашборд</Link>
          <Link href="/admin/products" className="px-4 py-3 text-sm font-medium text-text-muted hover:text-text">Товары</Link>
          <Link href="/admin/orders" className="px-4 py-3 text-sm font-medium text-accent border-b-2 border-accent">Заказы</Link>
        </div>
      </nav>
