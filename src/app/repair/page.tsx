...
export const metadata: Metadata = {
  ...
  description:
    'Ремонт чемоданов любых брендов в собственном сервисном центре. Замена колёс, телескопических ручек, кодовых и TSA-замков, бегунков и молний. Гарантийный ремонт VIP COLLECTION и ARISTOCRAT — бесплатно. Послегарантийный — от 200 ₽ за деталь. Доставка чемодана в сервис через Я.Доставку.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Замена колёс, ручек, замков. Собственный сервисный центр. Гарантийный ремонт бесплатно. Приём чемоданов через Я.Доставку.',
    url: `${SITE_URL}/repair`,
    type: 'website',
    locale: 'ru_RU',
    siteName: SITE_NAME,
